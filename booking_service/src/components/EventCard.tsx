        ...
        <>
            {start_date && end_date && (
                <div className={`main__events-content-slide ${state === 'Завершено' ? 'event_closed' : ''}`}>
                    <Link to={`/events/${encodeURIComponent(id.toString())}`} className="main__events-content-slide-pic" draggable="false">
                    ...
                    <Link to={`/events/${encodeURIComponent(id.toString())}`} className="main__events-content-slide-head">
                        {name}
                    </Link>
