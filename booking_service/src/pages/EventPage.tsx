        ...
        <>
            ...
            {!isLoading || (auth === AuthorizationStatus.Auth && !isLoadingInfoForRegister) ? (
                <>
                    ...
                    <main className="event_page display_none_print">
                        {auth === AuthorizationStatus.Auth && !me?.first_name && !me?.last_name && !me?.patronymic && !me?.city && (
                        ...
                        <div className="event display_none_print">
                            ...
                            <section className="event__host">
                                ...
                                <div className="event__host-pic">
                                    <img
                                        src={`${event?.creator.photo_url ? event?.creator.photo_url : '/svg/defaultUser1.svg'}`}
                                        alt="host"
                                    />
                                </div>
